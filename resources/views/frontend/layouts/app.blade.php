...
<div class="main">
    <section id="navbar">
        <nav class="navbar navbar-expand-lg navbar-light wow animate__animated animate__fadeInDown">
            <div class="container">
                <a class="navbar-brand" href="#"><span class="name"><img class="logo" src="{{asset('logo/logo.jpg')}}" alt=""></span></a>

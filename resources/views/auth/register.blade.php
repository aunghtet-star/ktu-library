<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Roll no -->
        <div class="mt-4">
            <x-input-label for="roll_no" :value="__('Roll_no')" />
            <x-text-input id="roll_no" class="block mt-1 w-full" type="text" name="roll_no" :value="old('roll_no')" required autocomplete="username" />
